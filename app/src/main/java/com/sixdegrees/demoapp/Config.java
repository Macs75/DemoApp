...
package com.sixdegrees.demoapp;

import android.net.Uri;

import com.sixdegrees.demoapp.util.ParserUtils;
...
public class Config {
    ...
    public static final long[][] CONFERENCE_DAYS = new long[][] {
            ...
            { ParserUtils.parseTime("2015-06-25T07:00:00.000Z"),
              ParserUtils.parseTime("2015-06-26T06:59:59.999Z") },
            // start and end of day 2
            { ParserUtils.parseTime("2015-06-26T07:00:00.000Z"),
              ParserUtils.parseTime("2015-06-27T06:59:59.999Z") },
        };
